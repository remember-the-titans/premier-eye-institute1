        ...
        {services.map((s, i) => (
          ...
          >
            <Link
              ...
              className="group flex h-full flex-col rounded-lg border border-ink/[0.08] bg-surface p-7 pb-8 transition-all duration-[400ms] ease-[var(--ease-soft)] hover:-translate-y-1 hover:border-ink/[0.14] hover:shadow-warm focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-accent"
            >
